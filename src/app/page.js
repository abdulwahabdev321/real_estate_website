...
const services = [
  {
    ...
    title: "Lettings",
    description:
      "Find your perfect rental property with our extensive portfolio of quality homes across East London.",
    href: "/lettings",
  ...
  },
  {
    ...
    title: "Sales",
    description:
      "Whether buying or selling, our expert team ensures smooth transactions and the best market value.",
    href: "/sales",
  ...
  },
  {
    ...
    description:
      "Full-service property management tailored to landlords who want hassle-free rental income.",
    href: "/landlord",
...
const testimonials = [
  {
    ...
    role: "Happy Tenant",
    content:
      "Preview Estates made finding my dream home so easy. Their team was professional, responsive, and genuinely cared about finding the right fit for me.",
    rating: 5,
  },
  {
    name: "Michael Chen",
    role: "Property Owner",
    content:
      "As a landlord, I've never had such peace of mind. Their property management service is exceptional - my properties are always occupied with quality tenants.",
    rating: 5,
  },
  {
    name: "Emma Williams",
    ...
    content:
      "Buying my first home was daunting, but the team at Preview Estates guided me through every step. I couldn't be happier with my new place!",
    rating: 5,
  },
];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8 sm:mb-10 animate-fade-in delay-200 px-2">
            Your trusted partner for property lettings, management, and sales in
            East London. Discover exceptional homes with our expert guidance.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 animate-fade-in delay-300 px-4">
            ...
            <Link
              href="/contact"
              className="btn-outline !text-white !border-white hover:!bg-white hover:!text-black w-full sm:w-auto px-6 sm:px-8"
            >
              Get in Touch
            </Link>
          </div>
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeading
            ...
            title={
              <>
                Comprehensive{" "}
                <span className="text-red-600">Real Estate Solutions</span>
              </>
            }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 md:-bottom-8 right-2 sm:-right-4 md:-right-6 lg:-right-8 bg-white rounded-xl shadow-xl p-2 sm:p-3 md:p-4 animate-float max-w-[140px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-none">
                <div className="flex items-center gap-1 sm:gap-2 md:gap-3">
                  <div className="w-6 h-6 sm:w-8 sm:h-10 md:w-12 md:h-12 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0">
                    <svg
                      className="w-3 h-3 sm:w-4 sm:h-5 md:w-6 md:h-6 text-red-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-gray-900 leading-tight">
                      15+
                    </p>
            ...
            <div className="animate-fade-in-right">
              ...
              <p className="text-gray-600 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
                With over 15 years of experience in the East London property
                market, Preview Estates has built a reputation for excellence,
                integrity, and personalized service. We understand that property
                decisions are significant, and we're here to make the process
      ...
      <section className="bg-gray-900 py-6 sm:py-8 overflow-x-hidden">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-3 sm:gap-4 text-white w-full lg:w-auto">
              ...
              <div className="min-w-0 flex-1">
                ...
                <a
                  ...
                  className="font-semibold hover:text-red-500 transition-colors text-sm sm:text-base break-words"
                >
                  020 3488 6585
                </a>
              </div>
            ...
            <Link
              href="/contact"
              className="btn-primary w-full lg:w-auto px-6 sm:px-8 text-center"
            >
              Book a Viewing
            </Link>
          </div>
