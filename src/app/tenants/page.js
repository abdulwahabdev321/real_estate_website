...
const faqs = [
  {
    ...
    answer:
      "You'll typically need proof of identity (passport or driving license), proof of address, proof of income (payslips or employment contract), bank statements, and references from previous landlords if applicable.",
  },
  {
    question: "How much deposit do I need to pay?",
    answer:
      "The deposit is typically equivalent to 5 weeks' rent for annual rents under £50,000, or 6 weeks' rent for higher amounts. Your deposit will be protected in a government-approved scheme.",
  },
  {
    question: "How long does the application process take?",
    answer:
      "Once we receive your completed application and all required documents, referencing typically takes 2-5 working days. We'll keep you updated throughout the process.",
  },
  {
    question: "Can I decorate or make changes to the property?",
    answer:
      "Any alterations or decorations need to be approved by the landlord in writing before you proceed. Minor changes may be permitted, but always check first.",
  },
  {
    question: "How do I report maintenance issues?",
    answer:
      "You can report maintenance issues through our online portal, by phone, or by email. We aim to respond to all non-emergency requests within 24-48 hours.",
  },
  {
    question: "What happens at the end of my tenancy?",
    answer:
      "We'll arrange a check-out inspection, and provided the property is in good condition, your deposit will be returned within 10 days of the tenancy ending.",
  },
];
...
export const metadata = {
  ...
  description:
    "Information and support for tenants. Find your perfect rental, understand your rights, and get support throughout your tenancy.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-left">
              <span className="inline-block px-4 py-1 bg-gray-600/20 text-gray-400 rounded-full text-sm font-semibold mb-4">
                Tenant Portal
              </span>
